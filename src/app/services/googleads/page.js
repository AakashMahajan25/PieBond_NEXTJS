...
export default function Home() {
  const faqData = [
    { question: 'Expertise That Delivers', answer: 'Our team embodies a wealth of expertise in Google Ads, continuously staying ahead of industry trends to deliver strategies that not only perform but surpass expectations.' },
    { question: 'Transparent Communication: Clarity in Every Step', answer: "We prioritize clear, jargon-free communication, ensuring that you're always in the loop and fully comprehend the strategies we implement, along with their direct impact on your business."},
    { question: 'ROI-Centric: Your Success, Quantified', answer: "Our primary focus is on maximizing your return on investment (ROI). With precision budget management, we ensure that every pound spent translates into tangible results, driving optimal outcomes for your business." },
    { question: 'Comprehensive Ad Management: Covering All Bases', answer: "With our comprehensive ad management services, we ensure your brand's omnipresence across digital platforms, from search to social media ads, effectively maximizing your online visibility and reach." },
  ...
  return (
    <div ClassName="flex flex-col ">
      ...
      <Banner />
      <Proven
      desc1 = "Discover our curated selection of data-driven digital marketing strategies, meticulously designed to empower your business&apos;s online success, all within the parameters of a succinct word limit."
      desc2 = "Leverage the expertise of our certified professionals, equipped with the knowledge and skills to optimize your digital marketing endeavors for maximum impact within the confines of a succinct word limit."

      desc3 = "Experience unparalleled results with our commitment to delivering impressive outcomes, seamlessly integrating expertise, innovation, and personalized digital marketing strategies within the constraints of a succinct word limit."
      />
      <ServiceCard
      ...
      <Drawer title="Understanding Google Ads"
      ...
      />
      <Section2 title="Generate Better ROI with a Proven Google Ads Strategy"
